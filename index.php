...
<body id="fondoLogin">
    <div class="container-fluid animated fadeInLeft">
        <div class="row justify-content-center ">
            <div class="col-md-4 col-sm-12 col-12 mt-5 px-0 mx-0  ">
                <!--inicio primera columna-->
                <div class="card h-100 tarjeta-color">
                    <!--<img class="card-img-top" src="holder.js/100x180/" alt="">-->
                    <div class="card-body">
                        <h4 class="card-title text-center text-black mt-5">BIENVENIDOS!</h4>
                        <form action="app/backend/validarLogin/validarSesion.php" method="post">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-6 col-sm-4">
                                    <a href="app/vistas/paginas/V_registroUsuario.php" class="form-control rounded-pill p-2 mt-4 text-center bg-warning">Registrate</a>
        ...
        <div class="col-md-4   mt-5 px-0 mx-0">
            ...
            <img src="https://i.blogs.es/b53e56/hands-water-poor-poverty/450_1000.jpg" alt="" class="w-100 h-100">
        </div>
